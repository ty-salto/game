...
const frontFaceImages = ["ace-of-pentacles", "devil", "empress", "hermit", "star", "three-of-cups"];
...
function buildCard(card) {
    ...
    backFace.src = '../images/back-face.png';
...
function handleCardClick(event) {
    ...
    if (waitingEndOfMove || clickedCard === activeCard || clickedCard.classList.contains('flip')) {
        return;
    }
